...
echo "DB_USER=$POSTGRES_USER" > "$APP_DIR/.env"
echo "DB_PASS=$POSTGRES_PASSWORD" >> "$APP_DIR/.env"
echo "DB_NAME=$POSTGRES_DB" >> "$APP_DIR/.env"
echo "DATABASE_URL_INTERNAL=$DATABASE_URL" >> "$APP_DIR/.env"
echo "DATBASE_URL=$DATABASE_URL_EXTERNAL" >> "$APP_DIR/.env"
